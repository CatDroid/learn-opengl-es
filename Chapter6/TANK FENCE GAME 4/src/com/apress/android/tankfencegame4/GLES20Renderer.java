...
public class GLES20Renderer implements Renderer {
	...
	public void onSurfaceCreated(GL10 gl, EGLConfig config) {
		...
		// 10.0005, 10.0, 0.1005
		GLES20Renderer._enemies.add(new Enemy(10.0005f, 10.0f, 0));
		GLES20Renderer._enemies.add(new Enemy(-3 * 10.0005f, 10.0f, 0));
		GLES20Renderer._enemies.add(new Enemy(-3 * 10.0005f, -3 * 10.0f, 0));
		GLES20Renderer._enemies.add(new Enemy(10.0005f, -3 * 10.0f, 0));
	}
	...
	public void onSurfaceChanged(GL10 gl, int width, int height) {
		...
		Matrix.setLookAtM(_ViewMatrix, 0, 0, 0, 80, 0, 0, 0, 0, 1, 0);
	...
	private void updateModel(int upDown, float zAngle) {
		...
		while(missilesIterator.hasNext()) {
			...
			if(missile.getDestinationPositionX() < -40 || missile.getDestinationPositionX() > 40 
					|| missile.getDestinationPositionY() < -20 || missile.getDestinationPositionY() > 20) {
