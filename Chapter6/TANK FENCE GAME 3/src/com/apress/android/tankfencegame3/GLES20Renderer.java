package com.apress.android.tankfencegame3;
...
public class GLES20Renderer implements Renderer {
	...
	private void updateModel(int upDown, float zAngle) {
		...
		while(missilesIterator.hasNext()) {
			...
			if(missile.getDestinationPositionX() < -30 || missile.getDestinationPositionX() > 30 
					|| missile.getDestinationPositionY() < -15 || missile.getDestinationPositionY() > 15) {
	...
	private void renderModel(GL10 gl) {
		...
		GLES20.glUniformMatrix4fv(_enemyUMVPLocation, 1, false, _planeVPMatrix, 0);
