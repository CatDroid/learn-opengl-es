package com.apress.android.vertexpointlighting;
...
public class GLES20Renderer implements Renderer {
	...
	private final String _tankVertexShaderCode = 
		...
		+	"																			\n"
		+	" // diffuseIntensity = Ld * Kd * max(dot(ds, normal), ambientIntensity);	\n"
	...
	private final String _tankFragmentShaderCode = 
			"precision lowp float; // not to be done in a vertex shader			\n"
		+	"varying float diffuseIntensity;									\n"
		+	"void main() {														\n"
